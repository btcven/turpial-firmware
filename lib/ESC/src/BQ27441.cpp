...
esp_err_t BQ27441::readExtendedData(std::uint8_t class_id, std::uint8_t offset,
                                    std::uint8_t &result) {
...
esp_err_t BQ27441::writeExtendedData(std::uint8_t class_id, std::uint8_t offset,
                                     std::uint8_t *data, std::uint8_t len) {
  if (len > 32) {
...
esp_err_t BQ27441::i2cWriteBytes(std::uint8_t sub_address, std::uint8_t *bytes,
                                 std::size_t length) {
...
esp_err_t BQ27441::i2cReadBytes(std::uint8_t sub_address, std::uint8_t *bytes,
                                std::size_t count) {
